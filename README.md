...
* If you use SQL Server or Azure SQL Databases to store data for your applications, the [MS SQL](https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql) extension will be helpful. It enables you with SQL database connectivity directly within Visual Studio Code. With handy commands for connecting to database servers or instances, in-editor query results views, and IntelliSense completion for SQL, you'll be able to validate your code is manipulating your data properly without leaving Visual Studio Code. 
